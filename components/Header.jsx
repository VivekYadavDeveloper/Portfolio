    ...
    return (
        <div className='w-11/12 max-w-3xl text-center mx-auto min-h-dvh flex flex-col items-center justify-center gap-4 p-15'>
            ...
            <motion.h1
                ...
                className='text-3xl sm:text-6xl lg:text-[36px] font-ovo'>I&apos;m a  Mobile App & Web developer with 3 years of experience. I enjoy building sites & apps. My focus is Flutter, Jetpack Compose, React (Next.js) & Springboot.</motion.h1>
