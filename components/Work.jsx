            ...
            <motion.div
                ...
                {workData.map((projects, index) => (
                    <motion.div
                        ...
                        key={index} className='bg-white/45 aspect-square bg-no-repeat bg-cover bg-center rounded-lg relative cursor-pointer group'>
                        {/* if wanna add backgroundImage image use this commented line in div class style={{ backgroundImage: `url(${projects.bgImage})` }} */}
                        <div className='bg-white w-10/12 rounded-md absolute bottom-5  left-1/2 -translate-x-1/2 py-3 px-5 flex items-center justify-between duration-500 group-hover:bottom-7'>
                            ...
                            <div>
                                ...
                                <div className='border rounded-full border-black w-10 aspect-square flex items-center justify-center shadow-dark group-hover:bg-purple-100 transition duration-500'>
